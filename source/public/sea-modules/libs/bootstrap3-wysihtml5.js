define("libs/bootstrap3-wysihtml5", [ "$" ], function(require, exports, module) {
...
!function($, wysi) {
    ...
    var tpl = {
        ...
        "align": function(locale, options) {
            ...
            return "<li>" +
                "<div class='btn-group'>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyLeft' title='左对齐' tabindex='-1'><i class='glyphicon glyphicon-align-left'></i></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyCenter' title='居中对齐' tabindex='-1'><i class='glyphicon glyphicon-align-center'></i></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyRight' title='右对齐' tabindex='-1'><i class='glyphicon glyphicon-align-right'></i></a>" +
                "</div>" +
                "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/stylesheets/common/bootstrap3-wysiwyg5-color.css"], // (path_to_project/lib/css/bootstrap3-wysiwyg5-color.css)
        locale: "zh-CN"
    };
